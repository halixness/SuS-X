...
python generate_sd_sus.py --dataset $1 --num_images $nSupportImages --prompt_shorthand $promptStrategy --huggingface_key $HFKEY --batch_size $batchSize
...
python tipx_classes.py --dataset domainnet_clipart --backbone RN50 --prompt_shorthand photo --sus_type sd --text_prompt_type ensemble 